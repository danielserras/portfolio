...
export const backend = [
  ...
  },
  {
    ...
    projetos: [
      {
        descricao:
          "O projeto da cadeira pretendeu familiarizar os alunos com alguns problemas envolvidos na programação de aplicações distribuídas seguras, nomeadamente a gestão de chaves criptográficas, a geração de sínteses seguras, cifras e assinaturas digitais, e a utilização de canais seguros à base do protocolo TLS. Numa primeira fase o objetivo passou por desenvolver a aplicação distribuída básica a ser executada numa sandbox. Na segunda fase foram adicionadas várias funcionalidades de segurança como: cifras, assinaturas, comunicação através de um protocolo seguro (TLS) e a gestão básica de certificados. Por fim, na terceira fase, foram configurados mecanismos de segurança ao nível do servidor, nomeadamente uma firewall e um sistema de deteção de intrusões.",
  ...
  },
  {
    ...
    projetos: [
      {
        descricao:
          "O projeto passou pela escolha de um dataset de dimensões consideráveis >1GB, Após isso foram escolhidos alguns casos de uso com base no dataset escolhido, e especificada uma API REST. Posteriormente, foi realizada a implementação baseada em microsserviços com recurso à framework Flask. Os diferente microsserviços foram colocados em containers, bem como foi automatizado o building e o deployment. Numa fase seguinte, os containers fora instalados num kubernetes cluster, e foram configuradas as políticas de escalabilidade, entre outros pormenores. Na quinta fase foi adicionado o padrão database per service e CQRS, o padrão circuit breaker, e o padrão application metrics. Por fim, foi testada a aplicação em diversos pontos, desde da segurança à performance, à otimização de custos, entre outros pontos relevantes.",
        tecnologias: [
          "Flask",
          "OpenAPI",
          "Swagger",
...
export const fullstack = [
  {
    ...
    projetos: [
      {
        descricao:
          "Neste projeto foi desenvolvida uma aplicação web com o objetivo de disponibilizar uma platafoma que permitisse vender e comprar pratos de comida caseira, bem como outros requisitos diretamente ligados, por exemplo página de administração, mecanismo de autenticação, pesquisa de pratos, adicionar pratos, avaliar pratos e vendedores, chat, entre outros. Bem como a criação de webservices SOAP.",
        tecnologias: [
          "PHP",
          "HTML",
          "CSS",
  ...
  },
  {
    ...
    projetos: [
      {
        descricao:
          "Este projeto foi dividido em três partes. Uma primeira parte onde foi desenvolvida toda a camada de dados para uma aplicação de chat online, onde foi desenvolvido o programa respeitando a separação entre camadas, e aplicado o padrão Data Mapper, e usando uma hierarquia de interfaces/classes adequada optimizando assim a reutilização do código. Na segunda fase, foram implementadas as queries. Na terceira e última fase, foi realizada a camada de apresentação, com recurso a páginas JSP, e foi posto em prática também o uso de Beans.",
